...
class OptionsMenu extends MusicBeatState
{
	...
	public var options:Array<OptionCategory> = [
		new OptionCategory("Gameplay", [
			...
			new CustomizeNotes("Test haouirtefhouilk4jhreuioerjhnredtfgujkhn5rfiujhuiojrtkfhuirtjhuitrhkjlhtreuijkhgreuijrehuijgrehyoiuhregjluohgreouijlhgreoujehgruik3rgjhugrlkjihreguikjlhregiulkhrgeukjrgehuijkrgehuklregjhgruekjhregukjhrgejukreghjkgrhrkegjlhrg")
		]),
